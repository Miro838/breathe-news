...
// Fetch comments
// Fetch comments
$section = 'trending_news'; // Replace with the dynamic section if needed

// Fetch comments based on item_id and section
...
$related_query = "SELECT id, title, introduction,description, thumbnail,final_thoughts FROM articles WHERE category_name = ? AND id != ? LIMIT 5";
...
<div class="news-container" style="margin-top:70px">
    ...
    <div class="star-rating">
        ...
        <div class="inline-images">
            <img src="uploads/inline_images/<?php echo htmlspecialchars($article['inline_image_1']); ?>" alt="Inline Image 1">
        ...
        <div class="content-layout">
            ...
            <img src="uploads/inline_images/<?php echo htmlspecialchars($article['inline_image_2']); ?>" alt="Inline Image 2" style="width:500px;">
        </div>
        <div class="divider"></div>
        <div class="inline-images">
            <img src="uploads/inline_images/<?php echo htmlspecialchars($article['inline_image_3']); ?>" alt="Inline Image 3">
    ...
    <aside class="sidebar">
     ...
     <div class="comments-section">
            <h2>Comments</h2>
            <form action="c.php?id=<?php echo htmlspecialchars($article_id); ?>" method="post">
                ...
                <div class="comment">
                    ...
                    <?php if ($comment['user_id'] == $_SESSION['user_id']): ?>
                        ...
                        <div id="comment-options-<?php echo htmlspecialchars($comment['id']); ?>" class="comment-options">
                            ...
                            <a href="c.php?id=<?php echo htmlspecialchars($article_id); ?>&delete_comment=<?php echo htmlspecialchars($comment['id']); ?>" onclick="return confirm('Are you sure?')">Delete</a>
                        </div>
