...
<div id="homePage" class="container mt-5 pt-5">
    ...
    <div class="row mb-4">
        <div class="col-md-12">
            <div class="input-group">
                <form action="job_search.php" method="post" class="w-100 d-flex">
    ...
    <div class="job-cards-container">
        ...
        if (!empty($jobOffers)) {
            foreach ($jobOffers as $offer) {
                ...
                echo '<a href="signup.php .  " class="btn btn-primary">Apply</a>';
    ...
    <div class="nav-buttons mt-3 d-flex justify-content-between">
        <button onclick="prevOffer()" class="btn btn-primary"><</button>
