...
<div id="homePage" class="container mt-5 pt-5">
    ...
    <div class="categoryCarousel">
        ...
        <div class="row">
            <?php while ($category = mysqli_fetch_assoc($categoriesQuery)): ?>
                <div class="col-md-4 mb-4 job-card" style="background-color:#d3c1ff;height:580px;" >
                    <div class="card category-card" style="margin-top:25px">
                        <div id="carousel<?php echo $category['id']; ?>" class="carousel slide" data-ride="carousel" >
                            <div class="carousel-inner" >
                          <?php  // Fetch articles for the current category
                                ...
                                echo '<p style="color:black">Total Articles: ' . $stats['article_count'] . '</p>';
                                echo '<p style="color:black">Last Updated: ' . $stats['last_updated'] . '</p>';
    ...
    <div class="nav-buttons mt-3 d-flex justify-content-between" >
        <button onclick="prevCategory()" class="btn btn-primary" style="color:purple;background-color:white"><</button>
        <button onclick="nextCategory()" class="btn btn-primary" style="color:purple;background-color:white">></button>
    </div>
</div>
